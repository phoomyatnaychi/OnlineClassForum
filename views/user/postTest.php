...
<?php if ($result && $result->num_rows > 0): ?>
    ...
    <div class="post-card" data-category="<?= $row['category'] ?>">
        ...
        <div class="content-section">
            ...
            <p class="text-gray-700 text-sm mb-3"><?= htmlspecialchars($row['content']) ?></p>
...
// Save tab choice to sessionStorage
...
filterPosts(initialTab);
setActiveTab(initialTab);

// On page load, restore tab from sessionStorage (default = all)
const savedTab = sessionStorage.getItem('currentTab') || 'all';
