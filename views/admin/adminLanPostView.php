...
$sql = "SELECT * FROM language_class_info ORDER BY created_at DESC";
...
<title>Admin Panel - Language Posts View</title>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="adminLanPostCreate.php" class="bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-700 flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <a href="adminLanPostDetail.php?id=<?= $row['language_id'] ?>" class="block hover:shadow-lg transition-shadow">
                    <?php if(!empty($row['lan_image'])): ?>
                        <img alt="Class Photo" class="w-full h-48 object-cover" 
                             src="data:image/jpeg;base64,<?= base64_encode($row['lan_image']); ?>"/>
                    <?php else: ?>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full bg-orange-200">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-2">
                                <a href="adminLanPostEdit.php?id=<?= $row['language_id'] ?>" class="text-blue-600 hover:text-blue-800">
                                    <span class="material-icons">edit</span>
                                </a>
                                <a href="../../app/models/adminLanPostDelete.php?id=<?= $row['language_id'] ?>" 
