...
<title>Admin Panel - YouthGuide</title>
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md" id="newPostForm">
        <div class="flex items-center mb-6">
            <button onclick="window.location.href='adminCodePostView.php'" 
    ...
    <form action="../../app/models/adminCodePostCreate.php" method="POST" enctype="multipart/form-data">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm" id="type" name="type" placeholder="e.g., Java, C#" type="text"/>
        </div>
        ...
        <div>
          ...
          <select class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm rounded-md" id="level" name="level">
